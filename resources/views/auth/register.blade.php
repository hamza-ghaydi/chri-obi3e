        ...
        <div class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            ...
            <div class="relative md:w-1/2 ">
                <img src="https://images.pexels.com/photos/280222/pexels-photo-280222.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                     ...
                     class="object-cover w-full h-full rounded-r-2xl hidden md:block">
                
                {{-- Text Overlay --}}
                <div 
                    class="absolute inset-0 bg-black/70 rounded-r-2xl hidden md:flex flex-col justify-between p-8 text-white">
